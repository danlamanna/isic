...
from .csv_streams import (
    ...
    csv_stream_with_filename_valid,
    csv_stream_with_isic_id_valid,
...
csv_stream_with_filename_valid = pytest.fixture(csv_stream_with_filename_valid)
csv_stream_with_isic_id_valid = pytest.fixture(csv_stream_with_isic_id_valid)
